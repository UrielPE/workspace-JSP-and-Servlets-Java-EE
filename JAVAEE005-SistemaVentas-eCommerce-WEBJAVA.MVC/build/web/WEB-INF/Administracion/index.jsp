...
<html lang="es">
    <head>
        ...
        <%@include file="${request.getContextPath()}/WEB-INF/partials/estilos.jsp" %>
    </head><!--/head-->
    <body>
        <%@include file="${request.getContextPath()}/WEB-INF/partials/header.jsp" %>
        ...
        <%@include file="${request.getContextPath()}/WEB-INF/partials/footer.jsp" %>
        <%@include file="${request.getContextPath()}/WEB-INF/partials/js.jsp" %>
    </body>
</html>
