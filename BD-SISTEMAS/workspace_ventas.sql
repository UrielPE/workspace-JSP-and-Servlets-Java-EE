...
--
-- Base de datos: `workspace_ventas`
--
...
(1, 17, 2, '000000001', '2019-05-08', 345, '1'),
(96, 19, 2, '000000002', '2019-09-03', 60, '1'),
(97, 17, 2, '000000003', '2019-09-03', 192, '1'),
(99, 20, 2, '000000004', '2019-09-03', 40, '1'),
(100, 20, 2, '000000005', '2019-06-14', 44, '1'),
(101, 17, 2, NULL, '2019-09-04', 3200, '1'),
(102, 17, 2, NULL, '2019-09-04', 3200, '1'),
(103, 17, 2, NULL, '2019-09-04', 3200, '1'),
(104, 17, 2, NULL, '2019-09-04', 3200, '1'),
(105, 17, 2, '000000006', '2019-09-04', 0, '1'),
(106, 20, 2, '000000006', '2019-09-04', 128, '1');
...
--
ALTER TABLE `detalle_ventas`
  MODIFY `IdDetalleVentas` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `ventas`
  MODIFY `IdVentas` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=107;
